...
<head>
    ...
    <style>
        *{{margin:0;padding:0;box-sizing:border-box}}
        ...
        h1{{text-align:center;font-size:28px;margin-bottom:24px;color:#f1f5f9}}
        .weekly-btn{{display:flex;align-items:center;justify-content:center;gap:8px;max-width:580px;margin:0 auto 28px;padding:16px;background:linear-gradient(135deg,#38bdf8,#818cf8);border-radius:12px;color:#fff;text-decoration:none;font-size:15px;font-weight:600;transition:all .2s;box-shadow:0 4px 20px rgba(56,189,248,.25)}}
        .weekly-btn:hover{{transform:translateY(-2px);box-shadow:0 8px 28px rgba(56,189,248,.35)}}
